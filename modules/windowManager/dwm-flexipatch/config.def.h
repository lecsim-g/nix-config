...
static const char *const autostart[] = {
	"slstatus", NULL,
	"hsetroot", "-center", "/etc/nixos/wallpapers/Space.png", NULL,
	NULL /* terminate */
};
...
static const char *soundplus[]  = { "amixer", "sset", "Master", "10%+", NULL };
static const char *soundminus[]  = { "amixer", "sset", "Master", "10%-", NULL };
static const char *browser[]  = { "chromium", NULL };
static const char *journal[]  = { "st", "-e", "tjournal", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_Return,     spawn,                  {.v = termcmd } },
        { MODKEY|ShiftMask,             XK_m,          spawn,                  {.v = networkcmd } },
        { MODKEY|ShiftMask,             XK_s,          spawn,                  {.v = browser } },
        { MODKEY,                       XK_q,          spawn,                  {.v = lock } },
        { MODKEY|ShiftMask,             XK_o,          spawn,                  {.v = journal } },
        { 0,                            XK_Print,      spawn,                  {.v = screenshot } },
        { MODKEY,                       XK_Up,         spawn,                  {.v = soundplus } },
        { MODKEY,                       XK_Down,       spawn,                  {.v = soundminus } },
        { MODKEY|ShiftMask,             XK_k,          spawn,                  {.v = passwords } },
	#if RIODRAW_PATCH
